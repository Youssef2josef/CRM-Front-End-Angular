...
@Component({
  selector: 'app-signup-responsable',
  templateUrl: './signup-responsable.component.html',
  styleUrls: ['./signup-responsable.component.css'],
  animations: [
    trigger('fadeInSpan', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class SignupResponsableComponent implements OnInit {
  regions: any =[];
